...
export default function EditSpeciesDialog({ species, userId }: { species: Species; userId: string }) {
  ...
  */
  ...
  const onSubmit = async (input: FormData) => {
    ...
    // Reset form values to the new species values.
    ...
    // Refresh all server components in the current route. This helps display the edited species because species are fetched in a server component, species/page.tsx.
    // Refreshing that server component will display the edited species from Supabase
    router.refresh();
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button type="button" className="ml-1 mr-1 mt-3 flex-auto" variant="secondary">
          Edit Species
        </Button>
      </DialogTrigger>
